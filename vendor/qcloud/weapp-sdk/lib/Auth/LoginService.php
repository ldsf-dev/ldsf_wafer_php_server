...
class LoginService
{
    public static function login()
    {
        try {
            ...
            //log_message('ldsf','loginResult:'.$loginResult);
            ...
            $result['session'] = array(
                ...
                'openid' => $loginResult['user_info']['openId'], // jumponline 20170315
                'unionid' => $loginResult['user_info']['unionId'] // jumponline 20170315
            );
    ...
    public static function check()
    {
        try {
            ...
            log_message('ldsf','checkResult:'.$checkResult);
    ...
    private static function writeError(LoginServiceException $err)
    {
        ...
        log_message('ldsf','error:'.$err->getType().' message:'.$err->getMessage());
